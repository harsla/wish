    ...
    _.each(context.internal.input, function (value, key) {
      if(_.isString(value) && _.has(schema, key) && schema[key].type !== "string") {
        switch(schema[key].type) {
          case "integer": context.internal.input[key] = parseInt(value); break;
          case "number": context.internal.input[key] = parseFloat(value); break;
          case "boolean": context.internal.input[key] = value === "true"; break;
        }
      }
    });
